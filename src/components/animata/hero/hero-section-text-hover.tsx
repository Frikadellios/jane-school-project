    ...
    >
      <div className="mb-2 flex flex-col items-center justify-center gap-3">
        <div className="text-normal flex flex-col items-center justify-center p-5 font-bold sm:text-xl md:text-2xl">
          <div className="mt-5">
            <MapIcon size={40} className="fill-zinc-900 text-neon-pink" />
          </div>
        ...
        <button
          type="button"
          className="cursor-pointer rounded-3xl bg-orange-400 px-4 py-2 font-mono tracking-tighter hover:bg-neon-pink"
        >
          Begin your journey
        </button>
      </div>
