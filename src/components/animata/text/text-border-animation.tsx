  ...
  return (
    <div onMouseEnter={handleHover} onMouseLeave={handleHoverExit} className="overflow-hidden">
      ...
      <div className="relative mt-1 h-1 w-full">
        <div
          className={cn(
            'absolute left-0 top-0 h-full w-full bg-neon-pink transition-transform duration-300',
            isHoveredIn ? 'translate-x-0 transform opacity-100' : '-translate-x-full transform opacity-0'
          )}
        />
        <div
          className={cn(
            'absolute left-0 top-0 h-full w-full translate-x-0 transform bg-neon-pink opacity-0 transition-transform duration-300',
