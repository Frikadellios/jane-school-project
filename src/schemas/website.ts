    ...
    webmanifest: fields.object(
      {
        themeColor: fields.text({
          ...
          description: t('ui-admin', 'website.webmanifest.themeColor.description'),
          validation: { length: { min: 1, max: 255 } }
        }),
        bgColor: fields.text({
        ...
        appleTouchIcon: fields.image({
          ...
          description: t('ui-admin', 'website.webmanifest.apple-touch-icon.description'),
          directory: 'public',
          publicPath: '/',
          validation: { isRequired: true }
        }),
        androidTouchIcon: fields.image({
          ...
          description: t('ui-admin', 'website.webmanifest.android-touch-icon.description'),
          directory: 'public',
          publicPath: '/',
          validation: { isRequired: true }
        }),
        androidSplashIcon: fields.image({
          ...
          description: t('ui-admin', 'website.webmanifest.android-splash-icon.description'),
          directory: 'public',
          publicPath: '/',
          validation: { isRequired: true }
        })
